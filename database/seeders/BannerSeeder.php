            ...
            'contenido_html' => <<<'HTML'
                <div style="background: oklch(55% 0.14 130); border-radius: 20px; padding: 32px 28px; margin: 8px 0 40px; color: white; display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <p style="margin: 0; font-size: 15px; line-height: 1.6; opacity: 0.95; max-width: 640px;">
                        Si eres alcalde, alcaldesa o representante de alguno de los pueblos de la comarca, regístrate en Aliste.es para mantener actualizada la información de tu localidad: noticias, eventos, puntos de interés y mucho más.
                    </p>
                    <div>
