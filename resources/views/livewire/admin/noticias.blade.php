...
<div>
    <div class="flex items-center justify-between mb-6">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Noticias</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Publicado</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 text-center">No hay noticias.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <form wire:submit="guardar" class="p-6">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea wire:model="extracto" id="extracto" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea
                        ...
                        class="mt-1 block w-full font-mono text-xs border-gray-300 dark:border-gray-600 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                    ></textarea>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Este contenido se mostrará tal cual (como HTML) en la página pública de la noticia.</p>
    ...
    <x-modal-confirmar-eliminar :id-a-eliminar="$idAEliminar" mensaje="¿Seguro que quieres eliminar esta noticia?" />
</div>
