        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('inicio') }}" wire:navigate class="bg-white rounded-md p-1 inline-flex">
            ...
            <div class="flex items-center gap-4 sm:hidden">
                @can('redactar-noticias')
                    <a href="{{ route('admin.dashboard') }}" wire:navigate
                        class="text-sm font-semibold {{ request()->routeIs('admin.*') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300' }}">
                        {{ __('Administración') }}
                    </a>
                @endcan

                <button @click="open = ! open" class="-me-2 inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
