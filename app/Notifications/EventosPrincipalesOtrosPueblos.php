...
class EventosPrincipalesOtrosPueblos extends Notification
{
    /**
    ...
    public function toWebPush(object $notifiable, self $notification): WebPushMessage
    {
        $titulo = $this->eventos->count() === 1
            ? 'Hoy hay 1 evento destacado en la comarca'
            : "Hoy hay {$this->eventos->count()} eventos destacados en la comarca";
